...
\ctusetup{
    ...
    title-english = {Model of CAN FD Communication Controller for QEMU Emulator -- Analysis and Transmission},
    title-czech = {Model kontroléru CAN FD v emulátoru QEMU -- analýza a vysílání},
